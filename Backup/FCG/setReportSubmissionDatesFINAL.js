        ...
        if (isFollowUp[0] === FOLLOW_UP_STATUS && parentAppointmentValue) {
            try {
                ...
                if (parentAppointmentEntry) {
                    ...
                    actions.push(C.setValue("1795685-submission-date", formatDate(parentAppointmentEntry["1795685-submission-date"])));
                    actions.push(C.setValue("1795685-completion-date", formatDate(parentAppointmentEntry["1795685-completion-date"])));
                } else {
            ...
            let reportReviewDate = adjustToNextWeekday(startMoment.clone().add(2, "weeks"));
            actions.push(C.setValue("1795685-submission-date", reportReviewDate.format("YYYY-MM-DD")));

            let requiredSubmissionDate = startMoment.clone().add(2, "weeks");
            ...
            actions.push(C.setValue("1795685-completion-date", requiredSubmissionDate.format("YYYY-MM-DD")));
        }
